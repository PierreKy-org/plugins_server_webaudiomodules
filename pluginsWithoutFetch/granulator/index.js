      ...
      class granulatorNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class granulatorPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new granulatorNode(this.audioContext);
