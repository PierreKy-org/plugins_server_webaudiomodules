      ...
      class korg35LPFNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class korg35LPFPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new korg35LPFNode(this.audioContext);
