...
class distortionNode extends CompositeAudioNode {
  _wamNode;
...
export default class distortionPlugin extends WebAudioModule {
  _PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new distortionNode(this.audioContext);
