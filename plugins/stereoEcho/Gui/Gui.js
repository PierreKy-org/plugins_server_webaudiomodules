import '../utils/webaudio-controls.js'
      ...
      export default class stereoEchoGui extends HTMLElement {
        ...
        this._root.innerHTML = `<style>.my-pedal {animation:none 0s ease 0s 1 normal none running;appearance:none;background:rgb(128, 128, 128) none repeat scroll 0% 0% / contain padding-box border-box;border:1px solid rgb(73, 73, 73);bottom:86px;clear:none;clip:auto;color:rgb(33, 37, 41);columns:auto auto;contain:none;content:normal;cursor:auto;cx:0px;cy:0px;d:none;direction:ltr;display:block;fill:rgb(0, 0, 0);filter:none;flex:0 1 auto;float:none;font:16px / 24px -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";gap:normal;grid:none / none / none / row / auto / auto;height:237px;hyphens:manual;inset:59px 1024px 86px 212px;isolation:auto;left:212px;margin:2px;marker:none;mask:none;offset:none 0px auto 0deg;opacity:1;order:0;orphans:2;outline:rgb(33, 37, 41) none 0px;overflow:visible;padding:1px;page:auto;perspective:none;position:unset;quotes:auto;r:0px;resize:none;right:1024px;rx:auto;ry:auto;speak:normal;stroke:none;top:59px;transform:none;transition:all 0s ease 0s;visibility:visible;widows:2;width:268px;x:0px;y:0px;zoom:1;};</style>
...
<div class="webaudio-knob-body" tabindex="1" touch-action="none" style="background-image: url(&quot;./img/knobs/slider_green.png&quot;); background-size: 128px 4040px; outline: none; width: 128px; height: 40px; background-position: 0px 0px; transform: rotate(0deg);"></div><div class="webaudioctrl-tooltip"></div>
</webaudio-knob></div><label for="stereo echo" style="display: block; touch-action: none; position: absolute; z-index: 1; width: 264px; left: 2px; top: 5px;" class="drag" contenteditable="false">stereo echo</label><label for="echo 1000" style="display: block; touch-action: none; position: absolute; z-index: 1; width: 124px; left: 72px; top: 41px;" class="drag" contenteditable="false">echo 1000</label><label for="feedback" style="text-align: center; display: block; touch-action: none; position: absolute; z-index: 1; width: 128px; left: 74px; top: 119.5px;" class="drag" contenteditable="false">feedback</label><label for="millisecond" style="text-align: center; display: block; touch-action: none; position: absolute; z-index: 1; width: 128px; left: 74px; top: 200px;" class="drag" contenteditable="false">millisecond</label></div>`;
