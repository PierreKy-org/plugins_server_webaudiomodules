import '../utils/webaudio-controls.js'
      ...
      export default class stereoEchoGui extends HTMLElement {
        ...
        this._root.innerHTML = `<style>.my-pedal {animation:none 0s ease 0s 1 normal none running;appearance:none;background:rgb(128, 128, 128) none repeat scroll 0% 0% / contain padding-box border-box;border:1px solid rgb(73, 73, 73);bottom:141.281px;clear:none;clip:auto;color:rgb(33, 37, 41);columns:auto auto;contain:none;content:normal;cursor:auto;cx:0px;cy:0px;d:none;direction:ltr;display:block;fill:rgb(0, 0, 0);filter:none;flex:0 1 auto;float:none;font:16px / 24px -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";gap:normal;grid:none / none / none / row / auto / auto;height:237px;hyphens:manual;inset:57.7188px 1024px 141.281px 212px;isolation:auto;left:212px;margin:2px;marker:none;mask:none;offset:none 0px auto 0deg;opacity:1;order:0;orphans:2;outline:rgb(33, 37, 41) none 0px;overflow:visible;padding:1px;page:auto;perspective:none;position:unset;quotes:auto;r:0px;resize:none;right:1024px;rx:auto;ry:auto;speak:normal;stroke:none;top:57.7188px;transform:none;transition:all 0s ease 0s;visibility:visible;widows:2;width:268px;x:0px;y:0px;zoom:1;};</style>
<div id="stereoEcho" class="resize-drag my-pedal" style="border: 1px solid rgb(73, 73, 73); text-align: center; display: inline-block; vertical-align: baseline; padding: 1px; margin: 2px; box-sizing: border-box; background-size: contain; box-shadow: rgba(0, 0, 0, 0.7) 4px 5px 6px, rgba(0, 0, 0, 0.2) -2px -2px 5px 0px inset, rgba(255, 255, 255, 0.2) 3px 1px 1px 4px inset, rgba(0, 0, 0, 0.9) 1px 0px 1px 0px, rgba(0, 0, 0, 0.9) 0px 2px 1px 0px, rgba(0, 0, 0, 0.9) 1px 1px 1px 0px; border-radius: 15px; background-color: grey; touch-action: none; width: 268px; position: relative; top: 0px; left: 0px; height: 237px;"><div id="stereoEcho" class="resize-drag" style="border: 1px solid rgb(73, 73, 73); text-align: center; display: inline-block; vertical-align: baseline; padding: 1px; margin: 2px; box-sizing: border-box; background-size: contain; border-radius: 15px; background-color: transparent; touch-action: none; width: 128px; position: absolute; top: 33px; left: 67px; height: 197px;"></div><div class="drag" style="padding: 1px; margin: 1px; text-align: center; display: inline-block; box-sizing: border-box; touch-action: none; position: absolute; top: 69px; left: 71px; width: 130px; height: 78.5px;"><webaudio-knob id="/stereo echo/echo 1000/feedback" src="./img/knobs/slider_green.png" sprites="100" min="0" max="100" step="0.1" width="128" height="40" style="touch-action: none; display: block;"><style>
...
</webaudio-knob></div><div class="drag" style="padding: 1px; margin: 1px; text-align: center; display: inline-block; box-sizing: border-box; touch-action: none; position: absolute; top: 149.5px; left: 71px; width: 130px; height: 78.5px;"><webaudio-knob id="/stereo echo/echo 1000/millisecond" src="./img/knobs/slider_green.png" sprites="100" min="0" max="1000" step="0.1" width="128" height="40" style="touch-action: none; display: block;"><style>
...
<div class="webaudio-knob-body" tabindex="1" touch-action="none" style="background-image: url(&quot;./img/knobs/slider_green.png&quot;); background-size: 128px 4040px; outline: none; width: 128px; height: 40px; background-position: 0px 0px; transform: rotate(0deg);"></div><div class="webaudioctrl-tooltip"></div>
</webaudio-knob></div><label for="stereo echo" style="display: block; touch-action: none; position: absolute; z-index: 1; width: 264px; left: 2px; top: 3.71875px;" class="drag" contenteditable="false">stereo echo</label><label for="echo 1000" style="display: block; touch-action: none; position: absolute; z-index: 1; width: 124px; left: 72px; top: 39.7188px;" class="drag" contenteditable="false">echo 1000</label><label for="feedback" style="text-align: center; display: block; touch-action: none; position: absolute; z-index: 1; width: 128px; left: 74px; top: 118.219px;" class="drag" contenteditable="false">feedback</label><label for="millisecond" style="text-align: center; display: block; touch-action: none; position: absolute; z-index: 1; width: 128px; left: 74px; top: 198.719px;" class="drag" contenteditable="false">millisecond</label></div>`;
