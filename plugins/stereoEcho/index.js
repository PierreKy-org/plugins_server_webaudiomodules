      ...
      class stereoEchoNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class stereoEchoPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new stereoEchoNode(this.audioContext);
