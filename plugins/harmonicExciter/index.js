      ...
      class harmonicExciterNode extends CompositeAudioNode {
          _wamNode;
    ...
    export default class harmonicExciterPlugin extends WebAudioModule {
  	_PluginFactory;
  ...
  async createAudioNode(initialState) {
    ...
    const node = new harmonicExciterNode(this.audioContext);
